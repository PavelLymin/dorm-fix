...
class ScrollableItem<T extends Object> {
  const ScrollableItem({required this.value, required this.title, this.icon});
...
class _UiScrollableControlState<T extends Object>
    extends State<UiScrollableControl<T>> {
  ...
  @override
  void didUpdateWidget(covariant UiScrollableControl<T> oldWidget) {
